...
public class assignment7  {
	public static void main(String[] args) {
		...
		dr.findElement(By.name("user_login")).sendKeys("aakansha2809");
		dr.findElement(By.name("user_password")).sendKeys("123456&*");
		dr.findElement(By.name("first_name")).sendKeys("Aakansha");
		dr.findElement(By.name("last_name")).sendKeys("Dhawan");
		dr.findElement(By.name("email")).sendKeys("aakansha@gmail.com");
		dr.findElement(By.name("address1")).sendKeys("Sector 41 Noida");
		...
		String s=dr.findElement(By.xpath("//*[text()='aakansha2809']")).getText();
		if(s.equals("aakansha2809"))
