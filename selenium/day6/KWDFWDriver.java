...
public class KWDFWDriver {
	...
	{
	case "launchBrowser":
		web_element_function.launchBrowser(d.test_data);
	break;
	case "clickLink":
		web_element_function.clickLink(d.path);
	break;
	case "enterText":
		web_element_function.enterText(d.path, d.test_data);
	break;
	case "clickButton":
		web_element_function.clickButton(d.path);
	break;
	case "verify":
	d.test_res=web_element_function.verify(d.path, d.test_data);
